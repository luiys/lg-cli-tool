...
export async function generatePrismaProject(options:any, { projectName, orm, flagBdConnection, bdOptions, flagSendEmail, flagGit }: InitAnswers) {

    try {

        const clone = Commands.cloneRepo(repoUri, projectName, orm)
